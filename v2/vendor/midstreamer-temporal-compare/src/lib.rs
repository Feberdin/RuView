//! Purpose: provide cached temporal-sequence comparison algorithms to RuView.
//! Input/Output: numeric or comparable sequences in; distances and matches out.
//! Invariants: preserve upstream 0.2.1 behavior while using memory-safe lru 0.18.
//! Debugging: run `cargo test -p midstreamer-temporal-compare` from `v2/`.
//!
//! # Temporal-Compare
//!
