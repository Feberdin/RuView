//! Purpose: preserve the algebraic invariants of the vendored comparison algorithms.
//! Input/Output: generated finite sequences in; deterministic invariant checks out.
//! Invariants: metrics stay non-negative, symmetric where specified, and stable.
//! Debugging: rerun this target with `PROPTEST_CASES=1` and the printed seed.
//!
